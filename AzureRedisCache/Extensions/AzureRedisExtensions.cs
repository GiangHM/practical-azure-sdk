...
namespace AzureRedisCache.Extensions
{
    ...
    {
        public static void AddAzureRedisWithOptionsAsync(this IServiceCollection services)
        {
            ...
            var configurationOptions = GetConfigsAsync(userConfigs);
        ...
        private static ConfigurationOptions GetConfigsAsync(RedisOptions option)
        {
            ...
            switch (option.ConnectionMode)
            {
                ...
                case ConnectionOptionConstants.UseAccessKey:
                    var configurationOptions = ConfigurationOptions.Parse(option.ConnectionString, true);
                    return configurationOptions;
                default:
                    break;
            }
